...
function SignUpForm() {
    ...
    const {toggleForms, fetchUserRegister, message, clearMessage,} = useContext(ToDoContext)
        ...
        <StyledSignUpForm>
            ...
            <form onSubmit={submitHandler}>
              ...
              <label htmlFor="surname">Surname:</label>
                <input type="text" name="surname" id="surname" ref={surnameInputRef} required/>
              <label htmlFor="username">Username:</label>
                <input type="text" name="username" id="username" ref={usernameInputRef} required/>
